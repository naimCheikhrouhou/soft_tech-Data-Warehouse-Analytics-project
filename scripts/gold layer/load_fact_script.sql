    ...
    delete from gold.fact_products_sales;
...
DELETE FROM gold.fact_project_suivis;
...
select* from silver.employee_performance order by end_date

delete from gold.fact_employee_performance;
